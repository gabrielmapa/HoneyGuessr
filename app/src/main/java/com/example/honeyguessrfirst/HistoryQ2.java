...
public class HistoryQ2 extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter =1;
    private String[] keys = {"Siyam (9)", "Pito (7)", "Lima (5)", "Walo (8)"};
    private String textAnswer = "Walo (8)";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.historyq2);
...
//        }, 15000);
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)) {
            Toast.makeText(HistoryQ2.this, "Tama! Ang sagot ay Walo (8)!", Toast.LENGTH_LONG).show();

            Intent b2 = new Intent(HistoryQ2.this, HistoryQ3.class);
            startActivity(b2);

        } else {
            Toast.makeText(HistoryQ2.this, "Mali! Subukan muli!", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
