...
public class HistoryQ1 extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter =1;
    private String[] keys = {"333 taon", "300 taon", "323 taon", "21 taon"};
    private String textAnswer = "333 taon";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.historyq1);
...
//        }, 45000);
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)) {
            Toast.makeText(HistoryQ1.this, "Tama! Ang sagot ay 333 taon!", Toast.LENGTH_LONG).show();

            Intent b1 = new Intent(HistoryQ1.this, HistoryQ2.class);
            startActivity(b1);

        } else {
            Toast.makeText(HistoryQ1.this, "Mali! Subukan muli!", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
