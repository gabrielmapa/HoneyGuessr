...
public class ArtsQ2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.artsq2);

//        timer = new Timer();
//        timer.schedule(new TimerTask() {
//            @Override
//            public void run() {
//                Intent qTimer = new Intent(ArtsQ2.this, ArtsQ3.class);
...
//        }, 15000);
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)) {
            Toast.makeText(ArtsQ2.this, "Tama! Ang sagot ay Batok!", Toast.LENGTH_LONG).show();

            Intent a2 = new Intent(ArtsQ2.this, ArtsQ3.class);
            startActivity(a2);

        } else {
            Toast.makeText(ArtsQ2.this, "Mali! Subukan muli!", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
