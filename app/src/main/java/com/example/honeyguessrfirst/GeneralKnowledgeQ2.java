...
public class GeneralKnowledgeQ2 extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter =1;
    private String[] keys = {"Davao", "Cebu", "Manila", "Bacolod"};
    private String textAnswer = "Cebu";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.generalknowledgeq2);
...
//        }, 45000);
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)) {
            Toast.makeText(GeneralKnowledgeQ2.this, "Tama! Ang sagot ay Cebu!", Toast.LENGTH_LONG).show();

            Intent c3 = new Intent(GeneralKnowledgeQ2.this, GeneralKnowledgeQ3.class);
            startActivity(c3);

        } else {
            Toast.makeText(GeneralKnowledgeQ2.this, "Mali! Subukan muli!", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
