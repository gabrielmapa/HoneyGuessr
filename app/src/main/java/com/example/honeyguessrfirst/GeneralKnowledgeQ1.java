...
public class GeneralKnowledgeQ1 extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter =1;
    private String[] keys = {"7,107 pulo", "2, 625 pulo", "7, 641 pulo", "5, 161 pulo"};
    private String textAnswer = "7, 641 pulo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.generalknowledgeq1);
...
//        }, 45000);
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)) {
            Toast.makeText(GeneralKnowledgeQ1.this, "Tama! Ang sagot ay 7, 641 pulo!", Toast.LENGTH_LONG).show();

            Intent c1 = new Intent(GeneralKnowledgeQ1.this, GeneralKnowledgeQ2.class);
            startActivity(c1);

        } else {
            Toast.makeText(GeneralKnowledgeQ1.this, "Mali! Subukan muli!", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
